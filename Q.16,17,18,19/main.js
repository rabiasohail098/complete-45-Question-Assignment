...
while (guest.length > 2) {
    ...
    console.log("\nDear ".concat(remove_Guest, ", Sorry you are not invited to dinner\n"));
}
for (var i = 0; i < guest.length; i++) {
    console.log("\nDear ".concat(guest[i], ", you are still invited for dinner\n"));
}
guest.splice(0, 2);
console.log(guest);
...
console.log("\nTotal No of guest are: ".concat(guest.length, "\n\n"));
...
• Sort to change your array so it’s stored in reverse alphabetical order. Print the list to show that its order
 has changed.
*/
var places = ["Karachi", "Lahore", "Islamabad", "Quetta", "Multan"];
//Print your array in its original order.
console.log("Original Order [".concat(places, "]\n"));
var origOrder = places.slice();
//Print your array in alphabetical order without modifying the actual list.
console.log("Alphabetical Order [".concat(places.sort(), "]\n"));
//Show that your array is still in its original order by printing it.
console.log("Original Order [".concat(origOrder, "]\n"));
// Print your array in reverse alphabetical order without changing the order of the original list.
console.log("Reverse Alphabetical Order [".concat(places.sort().reverse(), "]\n"));
// Show that your array is still in its original order by printing it again.
console.log("Original Order [".concat(origOrder, "]\n"));
// //• Reverse the order of your list. Print the array to show that its order has changed.
console.log("Reverse List [".concat(origOrder.reverse(), "]\n"));
// //Reverse the order of your list again. Print the list to show it’s back to its original order.
console.log("Rereverse (back to Original position) [".concat(origOrder.reverse(), "]\n"));
// //Sort your array so it’s stored in alphabetical order. Print the array to show that its order has been changed
var sortPlaces = places.sort();
console.log("Alphabetic Order [".concat(sortPlaces, "]\n"));
// // Sort to change your array so it’s stored in reverse alphabetical order. Print the list to show that its order
// //has changed.
console.log("Reverse Alphabetic Order [".concat(sortPlaces.reverse(), "]"));
